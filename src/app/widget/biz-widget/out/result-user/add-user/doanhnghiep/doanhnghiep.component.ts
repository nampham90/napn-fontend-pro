...
import { ChangeDetectorRef, Component, DestroyRef, Input, inject, signal } from '@angular/core';
...
@Component({
  ...
  styleUrl: './doanhnghiep.component.less'
})
export class DoanhnghiepComponent {
  ...
  initForm(): void {
    this.validateForm = this.fb.group({
      taxcd: [null, [Validators.required]],
      email: [null],
  ...
  submitForm(): void {
    ...
    this.addUser(this.validateForm.value);
  }

  addUser(param:User) {
    this.userService.addAccount(param)
