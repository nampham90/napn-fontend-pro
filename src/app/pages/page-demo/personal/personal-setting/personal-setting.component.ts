...
export class PersonalSettingComponent implements OnInit {
  ...
  settingComponent: TabInterface[] = [
    ...
    { key: 'safe', component: new DynamicComponent(SafeComponent, { label: 'Cài đặt bảo mật' }) },
    { key: 'bind', component: new DynamicComponent(BindComponent, { label: 'Liên kết tài khoản' }) },
    { key: 'notice', component: new DynamicComponent(NoticeComponent, { label: 'Thông báo tin nhắn mới' }) }
  ];
