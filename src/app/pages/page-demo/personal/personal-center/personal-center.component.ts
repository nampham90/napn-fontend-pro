...
import { Component, OnInit, ChangeDetectionStrategy, ViewChild, ElementRef, signal, DestroyRef, inject } from '@angular/core';
...
export class PersonalCenterComponent implements OnInit {
  tagArray: string[] = ['Sáng tạo', 'Tập trung vào thiết kế', 'Đôi chân dài', 'Gái nước Sichuan', 'Biển rộng sẵn lòng đón'];
  inputVisible = false;
